        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className='checkout-form__item'>
            ...
            <div className='align-items-center py-2 mb-2 smalls jazzCashgrid d-flex'>
                    ...
                    <input value="jazzcash" className="online_payment" type="radio" name="payment_option" onChange={(e)=>setPaymentType(e.target.value)} onClick={(e)=>setPaymentType(e.target.value)} defaultChecked/>
                    ...
                    <div className="payment-option-box">
                    <input value="Bank_Transfar" className="online_payment" type="radio" name="payment_option" onChange={(e)=>setPaymentType(e.target.value)} onClick={(e)=>setPaymentType(e.target.value)}/>
                    <div className="d-block p-3 payment-option-title">
           ...
           <div className="payment-option-box">
                    <input value="barclaycard" className="online_payment" type="radio" name="payment_option" onChange={(e)=>setPaymentType(e.target.value)} onClick={(e)=>setPaymentType(e.target.value)}/>
                    <div className="d-block p-3 payment-option-title">
           ...
           <div className="payment-option-box">
                    <input value="cash_on_delivery" className="online_payment" type="radio" name="payment_option" onChange={(e)=>setPaymentType(e.target.value)} onClick={(e)=>setPaymentType(e.target.value)}/>
                    <div className="d-block p-3 payment-option-title">
          ...
          <div className='checkout-buttons'>
            <button className='btn btn-grey btn-icon' onClick={() => router.push('/shop')}>
              {' '}
              <i className='icon-arrow' style={{color:"#fff !important"}}></i> back to shop
            </button>
