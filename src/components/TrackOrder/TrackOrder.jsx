...
export const TrackOrder = () => {
  const {Logout,user,name}=useContext(CartContext);
  ...
  return (
    ...
    {user.value &&  <div className='card' style={{boxShadow: "0 0 13px 0 rgb(82 63 105 / 5%)"}}>
        ...
        <div className='text-center'>
         ...
         {user.value && <h1 className='h5'>{name}</h1>}
        </div>
...
<HiOutlineUser className='aiz-side-nav-icon'/>Manage Profile</a>
  ...
  <div className='fs-15 fw-600 p-3 text-center'>
    ...
    {searchedProduct && searchedProduct.map((item)=>{
        const {code,date,grand_total,payment_type,shipping_address,delivery_status_string,delivery_status}=item;
    ...
    <div className="p-4" style={{marginLeft:"auto",marginRight:"auto"}}>
                        ...
                        <ul className="list-inline text-center aiz-steps">
                            {delivery_status_string==='Order Placed'&& delivery_status==='pending'? <><li className="list-inline-item  done">
