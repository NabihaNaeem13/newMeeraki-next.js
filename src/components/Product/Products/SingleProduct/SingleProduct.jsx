...
export const SingleProduct = ({
  ...
  const { name,thumbnail_image,product_slug,hover_image,base_price,id,category_name,current_price,product_sku,current_stock,variant,variant_prices} = product;
  ...
  return (
    <>
      ...
      onMouseLeave={() => setIsHovered(false)}>
        ...
        <Link href={`/${category_name}/${product_slug}`}>
